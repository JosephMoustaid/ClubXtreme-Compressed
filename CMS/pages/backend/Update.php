...
function updateSeanceEntrainement(SceanceEntrainement $seance) {
    ...
    try {
        ...
        if ($seanceId) {
            ...
            $query = $db->prepare("UPDATE sceanceentrainement SET date = :date, lieu = :lieu, exercices = :exercices, entraineur=:entraineur WHERE id_SceanceEntrainement = :id_SceanceEntrainement");
            ...
            $query->bindValue(':entraineur', $seance->getEntraineur()->getIdEntraineur());
            $query->execute();
        } else {
